module pyth_v1::state {
    ...
    use pyth_v1::price_info::{Self};
    use pyth_v1::price_identifier::{Self, PriceIdentifier};
    use pyth_v1::version_control::{Self};
    ...
    friend pyth_v1::governance_action;
    friend pyth_v1::set_update_fee;
    friend pyth_v1::set_stale_price_threshold;
    friend pyth_v1::set_data_sources;
    friend pyth_v1::governance;
    friend pyth_v1::set_governance_data_source;
    friend pyth_v1::migrate;
    friend pyth_v1::contract_upgrade;
    friend pyth_v1::set_fee_recipient;
    friend pyth_v1::setup;
