module pyth_v1::set_data_sources {
    use std::vector;
...
#[test_only]
module pyth_v1::set_data_sources_tests {
    ...
    use pyth_v1::pyth_tests::{Self, setup_test, take_wormhole_and_pyth_states};
    use pyth_v1::state::Self;
    use pyth_v1::data_source::Self;
    ...
    fun set_data_sources(){
        ...
        let receipt = pyth_v1::governance::verify_vaa(&pyth_state, verified_vaa);

        test_scenario::next_tx(&mut scenario, DEPLOYER);

        pyth_v1::governance::execute_governance_instruction(&mut pyth_state, receipt);
