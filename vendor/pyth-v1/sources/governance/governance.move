module pyth_v1::governance {
    use pyth_v1::governance_instruction;
    use pyth_v1::governance_action;
    use pyth_v1::set_governance_data_source;
    use pyth_v1::set_data_sources;
    use pyth_v1::set_stale_price_threshold;
    use pyth_v1::set_fee_recipient;
    use pyth_v1::state::{Self, State};
    use pyth_v1::set_update_fee;
    ...
    public fun verify_vaa(
        ...
        let vaa_data_source = pyth_v1::data_source::new((vaa::emitter_chain(&verified_vaa) as u64), vaa::emitter_address(&verified_vaa));

        // The emitter chain and address must correspond to the Pyth governance emitter chain and contract.
        assert!(
            pyth_v1::state::is_valid_governance_data_source(pyth_state, vaa_data_source),
