...
/// 3.  Upgrade.
/// 4.  Commit upgrade.
module pyth_v1::contract_upgrade {
    use sui::event::{Self};
    use sui::object::{ID};
    ...
    use pyth_v1::governance_instruction::{Self};
    use pyth_v1::governance_action::{Self};
    use pyth_v1::governance::{Self, WormholeVAAVerificationReceipt};
...
#[test_only]
module pyth_v1::upgrade_contract_tests {
    // TODO
}
