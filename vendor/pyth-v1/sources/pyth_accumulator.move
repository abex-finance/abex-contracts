module pyth_v1::accumulator {
    ...
    fun parse_price_feed_message(message_cur: &mut Cursor<u8>, clock: &Clock): PriceInfo {
        ...
        let price_info = price_info::new_price_info(
            ...
            price_feed::new(
                price_identifier,
                pyth_v1::price::new(price, conf, expo, publish_time),
                pyth_v1::price::new(ema_price, ema_conf, expo, publish_time),
            )
        );
        price_info
    }
